...
export const addDoctor = async (req,res) => {
    try {
        const{name,email,degree,fees,about,gender,phone,address,image,speciality,experience,dob} = req.body
        if( !name || !email || !degree || !fees || !about || !gender || !phone || !address || !image || !speciality ||!experience || !dob){
